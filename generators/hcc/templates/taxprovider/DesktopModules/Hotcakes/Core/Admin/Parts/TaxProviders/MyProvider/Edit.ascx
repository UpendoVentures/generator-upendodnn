<<%= openDirective %> Control Language="C#" AutoEventWireup="true" CodeBehind="Edit.ascx.cs" Inherits="<%= fullNamespace %>.TaxProvider.Edit" <%= closeDirective %>>
<<%= openDirective %> Register Src="MessageBox.ascx" TagName="MessageBox" TagPrefix="hcc" <%= closeDirective %>>
<h1>
